...
POST /api/v1/routes/plan accepts an ddress or a lat/lon pair for origin and destination. Configure ONEMAP_ACCESS_TOKEN in .env before running it. Without OneMap authentication, it returns 503 instead of manufacturing transit legs.
